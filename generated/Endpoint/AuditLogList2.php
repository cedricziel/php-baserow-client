...
class AuditLogList2 extends \cedricziel\phpbaserowclient\Generated\Runtime\Client\BaseEndpoint implements \cedricziel\phpbaserowclient\Generated\Runtime\Client\Endpoint
{
     ...
     *
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\AuditLogList2BadRequestException
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\AuditLogList2UnauthorizedException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\AuditLogList2BadRequestException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiAuditLogGetResponse400', 'json'), $response);
        }
        if (401 === $status) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\AuditLogList2UnauthorizedException($response);
        }
    }
