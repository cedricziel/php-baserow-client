...
class CreateDatabaseTableViewGroup extends \CedricZiel\Baserow\Generated\Runtime\Client\BaseEndpoint implements \CedricZiel\Baserow\Generated\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(int $viewId, \CedricZiel\Baserow\Generated\Model\CreateViewGroupBy $requestBody, array $headerParameters = [])
    {
        $this->view_id = $viewId;
    ...
    {
        if ($this->body instanceof \CedricZiel\Baserow\Generated\Model\CreateViewGroupBy) {
     ...
     *
     * @throws \CedricZiel\Baserow\Generated\Exception\CreateDatabaseTableViewGroupBadRequestException
     * @throws \CedricZiel\Baserow\Generated\Exception\CreateDatabaseTableViewGroupNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\CreateDatabaseTableViewGroupBadRequestException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiDatabaseViewsViewIdGroupBysPostResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\CreateDatabaseTableViewGroupNotFoundException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiDatabaseViewsViewIdGroupBysPostResponse404', 'json'), $response);
        }
    }
