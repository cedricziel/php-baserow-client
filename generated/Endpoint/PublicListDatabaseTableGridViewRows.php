...
class PublicListDatabaseTableGridViewRows extends \CedricZiel\Baserow\Generated\Runtime\Client\BaseEndpoint implements \CedricZiel\Baserow\Generated\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \CedricZiel\Baserow\Generated\Model\PublicPaginationSerializerWithGridViewFieldOptionsExampleRowResponse|null
     *
     * @throws \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableGridViewRowsBadRequestException
     * @throws \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableGridViewRowsUnauthorizedException
     * @throws \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableGridViewRowsNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (200 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            return $serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\PublicPaginationSerializerWithGridViewFieldOptionsExampleRowResponse', 'json');
        }
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableGridViewRowsBadRequestException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiDatabaseViewsGridSlugPublicRowsGetResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (401 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableGridViewRowsUnauthorizedException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiDatabaseViewsGridSlugPublicRowsGetResponse401', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableGridViewRowsNotFoundException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiDatabaseViewsGridSlugPublicRowsGetResponse404', 'json'), $response);
        }
    }
