...
class WorkspaceCreateApplication extends \CedricZiel\Baserow\Generated\Runtime\Client\BaseEndpoint implements \CedricZiel\Baserow\Generated\Runtime\Client\Endpoint
{
     ...
     * @return null
     *
     * @throws \CedricZiel\Baserow\Generated\Exception\WorkspaceCreateApplicationBadRequestException
     * @throws \CedricZiel\Baserow\Generated\Exception\WorkspaceCreateApplicationNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\WorkspaceCreateApplicationBadRequestException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiApplicationsWorkspaceWorkspaceIdPostResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\WorkspaceCreateApplicationNotFoundException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiApplicationsWorkspaceWorkspaceIdPostResponse404', 'json'), $response);
        }
    }
