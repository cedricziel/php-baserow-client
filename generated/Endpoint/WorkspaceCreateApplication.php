...
class WorkspaceCreateApplication extends \cedricziel\phpbaserowclient\Generated\Runtime\Client\BaseEndpoint implements \cedricziel\phpbaserowclient\Generated\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(int $workspaceId, $requestBody = null, array $headerParameters = [])
    {
     ...
     * @return null
     *
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\WorkspaceCreateApplicationBadRequestException
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\WorkspaceCreateApplicationNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\WorkspaceCreateApplicationBadRequestException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiApplicationsWorkspaceWorkspaceIdPostResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\WorkspaceCreateApplicationNotFoundException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiApplicationsWorkspaceWorkspaceIdPostResponse404', 'json'), $response);
        }
    }
