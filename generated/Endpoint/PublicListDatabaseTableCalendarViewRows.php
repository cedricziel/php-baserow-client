...
class PublicListDatabaseTableCalendarViewRows extends \CedricZiel\Baserow\Generated\Runtime\Client\BaseEndpoint implements \CedricZiel\Baserow\Generated\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \CedricZiel\Baserow\Generated\Model\CalendarViewExampleResponse|null
     *
     * @throws \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableCalendarViewRowsUnauthorizedException
     * @throws \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableCalendarViewRowsBadRequestException
     * @throws \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableCalendarViewRowsNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (200 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            return $serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\CalendarViewExampleResponse', 'json');
        }
        if (false === is_null($contentType) && (401 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableCalendarViewRowsUnauthorizedException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiDatabaseViewsCalendarSlugPublicRowsGetResponse401', 'json'), $response);
        }
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableCalendarViewRowsBadRequestException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiDatabaseViewsCalendarSlugPublicRowsGetResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\PublicListDatabaseTableCalendarViewRowsNotFoundException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiDatabaseViewsCalendarSlugPublicRowsGetResponse404', 'json'), $response);
        }
    }
