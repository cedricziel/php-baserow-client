...
class AsyncAuditLogExport extends \cedricziel\phpbaserowclient\Generated\Runtime\Client\BaseEndpoint implements \cedricziel\phpbaserowclient\Generated\Runtime\Client\Endpoint
{
    ...
    {
        return '/api/admin/audit-log/export/';
    }
     ...
     *
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\AsyncAuditLogExportBadRequestException
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\AsyncAuditLogExportNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\AsyncAuditLogExportBadRequestException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiAdminAuditLogExportPostResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\AsyncAuditLogExportNotFoundException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiAdminAuditLogExportPostResponse404', 'json'), $response);
        }
    }
