...
class BatchCreateDatabaseTableRows extends \cedricziel\phpbaserowclient\Generated\Runtime\Client\BaseEndpoint implements \cedricziel\phpbaserowclient\Generated\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(int $tableId, \cedricziel\phpbaserowclient\Generated\Model\ExampleBatchRowsRequest $requestBody, array $queryParameters = [], array $headerParameters = [])
    {
    ...
    {
        if ($this->body instanceof \cedricziel\phpbaserowclient\Generated\Model\ExampleBatchRowsRequest) {
     ...
     *
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\BatchCreateDatabaseTableRowsBadRequestException
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\BatchCreateDatabaseTableRowsUnauthorizedException
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\BatchCreateDatabaseTableRowsNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\BatchCreateDatabaseTableRowsBadRequestException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiDatabaseRowsTableTableIdBatchPostResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (401 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\BatchCreateDatabaseTableRowsUnauthorizedException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiDatabaseRowsTableTableIdBatchPostResponse401', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\BatchCreateDatabaseTableRowsNotFoundException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiDatabaseRowsTableTableIdBatchPostResponse404', 'json'), $response);
        }
    }
