...
class AdminListGroups extends \cedricziel\phpbaserowclient\Generated\Runtime\Client\BaseEndpoint implements \cedricziel\phpbaserowclient\Generated\Runtime\Client\Endpoint
{
     ...
     *
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\AdminListGroupsBadRequestException
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\AdminListGroupsUnauthorizedException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\AdminListGroupsBadRequestException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiAdminGroupsGetResponse400', 'json'), $response);
        }
        if (401 === $status) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\AdminListGroupsUnauthorizedException($response);
        }
    }
