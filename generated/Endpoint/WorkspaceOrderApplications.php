...
class WorkspaceOrderApplications extends \CedricZiel\Baserow\Generated\Runtime\Client\BaseEndpoint implements \CedricZiel\Baserow\Generated\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(int $workspaceId, \CedricZiel\Baserow\Generated\Model\OrderApplications $requestBody, array $headerParameters = [])
    {
     ...
     * @return null
     *
     * @throws \CedricZiel\Baserow\Generated\Exception\WorkspaceOrderApplicationsBadRequestException
     * @throws \CedricZiel\Baserow\Generated\Exception\WorkspaceOrderApplicationsNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\WorkspaceOrderApplicationsBadRequestException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiApplicationsWorkspaceWorkspaceIdOrderPostResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \CedricZiel\Baserow\Generated\Exception\WorkspaceOrderApplicationsNotFoundException($serializer->deserialize($body, 'CedricZiel\Baserow\Generated\Model\ApiApplicationsWorkspaceWorkspaceIdOrderPostResponse404', 'json'), $response);
        }
    }
