...
class WorkspaceOrderApplications extends \cedricziel\phpbaserowclient\Generated\Runtime\Client\BaseEndpoint implements \cedricziel\phpbaserowclient\Generated\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(int $workspaceId, \cedricziel\phpbaserowclient\Generated\Model\OrderApplications $requestBody, array $headerParameters = [])
    {
    ...
    {
        return str_replace(['{workspace_id}'], [$this->workspace_id], '/api/applications/workspace/{workspace_id}/order/');
    }
     ...
     * @return null
     *
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\WorkspaceOrderApplicationsBadRequestException
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\WorkspaceOrderApplicationsNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\WorkspaceOrderApplicationsBadRequestException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiApplicationsWorkspaceWorkspaceIdOrderPostResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\WorkspaceOrderApplicationsNotFoundException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiApplicationsWorkspaceWorkspaceIdOrderPostResponse404', 'json'), $response);
        }
    }
