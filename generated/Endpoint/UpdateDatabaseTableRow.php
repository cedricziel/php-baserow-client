...
class UpdateDatabaseTableRow extends \cedricziel\phpbaserowclient\Generated\Runtime\Client\BaseEndpoint implements \cedricziel\phpbaserowclient\Generated\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(int $rowId, int $tableId, ?\cedricziel\phpbaserowclient\Generated\Model\PatchedExampleUpdateRowRequestSerializerWithUserFieldNames $requestBody = null, array $queryParameters = [], array $headerParameters = [])
    {
        $this->row_id = $rowId;
    ...
    {
        if ($this->body instanceof \cedricziel\phpbaserowclient\Generated\Model\PatchedExampleUpdateRowRequestSerializerWithUserFieldNames) {
     ...
     *
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\UpdateDatabaseTableRowBadRequestException
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\UpdateDatabaseTableRowUnauthorizedException
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\UpdateDatabaseTableRowNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\UpdateDatabaseTableRowBadRequestException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiDatabaseRowsTableTableIdRowIdPatchResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (401 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\UpdateDatabaseTableRowUnauthorizedException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiDatabaseRowsTableTableIdRowIdPatchResponse401', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\UpdateDatabaseTableRowNotFoundException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiDatabaseRowsTableTableIdRowIdPatchResponse404', 'json'), $response);
        }
    }
