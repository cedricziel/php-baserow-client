...
class UpdateDatabaseTableField extends \cedricziel\phpbaserowclient\Generated\Runtime\Client\BaseEndpoint implements \cedricziel\phpbaserowclient\Generated\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(int $fieldId, $requestBody = null, array $headerParameters = [])
    {
     ...
     * @return null
     *
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\UpdateDatabaseTableFieldBadRequestException
     * @throws \cedricziel\phpbaserowclient\Generated\Exception\UpdateDatabaseTableFieldNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (400 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\UpdateDatabaseTableFieldBadRequestException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiDatabaseFieldsFieldIdPatchResponse400', 'json'), $response);
        }
        if (false === is_null($contentType) && (404 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \cedricziel\phpbaserowclient\Generated\Exception\UpdateDatabaseTableFieldNotFoundException($serializer->deserialize($body, 'cedricziel\phpbaserowclient\Generated\Model\ApiDatabaseFieldsFieldIdPatchResponse404', 'json'), $response);
        }
    }
