...
class RepeatElementPublicElement extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var RepeatElementPublicElementStyleBackgroundFile|null
     */
     ...
     * The background image file.
     */
    public function getStyleBackgroundFile(): ?RepeatElementPublicElementStyleBackgroundFile
    {
     ...
     * The background image file.
     */
    public function setStyleBackgroundFile(?RepeatElementPublicElementStyleBackgroundFile $styleBackgroundFile): self
    {
     ...
     * The label of the show more button.
     */
    public function getButtonLoadMoreLabel(): string
    {
        return $this->buttonLoadMoreLabel;
    }

    /**
     * The label of the show more button.
     */
    public function setButtonLoadMoreLabel(string $buttonLoadMoreLabel): self
    {
        $this->initialized['buttonLoadMoreLabel'] = true;
        $this->buttonLoadMoreLabel = $buttonLoadMoreLabel;
     ...
     * The amount repetitions per row, per device type. Only applicable when the orientation is horizontal.
     */
    public function setItemsPerRow($itemsPerRow): self
    {
        $this->initialized['itemsPerRow'] = true;
