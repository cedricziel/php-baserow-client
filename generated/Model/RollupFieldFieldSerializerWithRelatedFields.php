...
class RollupFieldFieldSerializerWithRelatedFields extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The rollup formula function that must be applied.
     */
    public function getRollupFunction(): string
    {
     ...
     * The rollup formula function that must be applied.
     */
    public function setRollupFunction(string $rollupFunction): self
    {
        $this->initialized['rollupFunction'] = true;
