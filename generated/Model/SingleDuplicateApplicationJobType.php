...
class SingleDuplicateApplicationJobType extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    protected $duplicatedApplication;
    ...
    public function getOriginalApplication()
    {
        return $this->originalApplication;
    }

    public function setOriginalApplication($originalApplication): self
    {
        $this->initialized['originalApplication'] = true;
        $this->originalApplication = $originalApplication;

        return $this;
    }

    public function getDuplicatedApplication()
    {
        return $this->duplicatedApplication;
    }

    public function setDuplicatedApplication($duplicatedApplication): self
    {
        $this->initialized['duplicatedApplication'] = true;
