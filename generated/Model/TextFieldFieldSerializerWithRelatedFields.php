...
class TextFieldFieldSerializerWithRelatedFields extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * If set, this value is going to be added every time a new row created.
     */
    public function setTextDefault(string $textDefault): self
    {
        $this->initialized['textDefault'] = true;
