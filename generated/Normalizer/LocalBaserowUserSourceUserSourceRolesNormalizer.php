...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocalBaserowUserSourceUserSourceRolesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \cedricziel\phpbaserowclient\Generated\Model\LocalBaserowUserSourceUserSourceRoles::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \cedricziel\phpbaserowclient\Generated\Model\LocalBaserowUserSourceUserSourceRoles::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \cedricziel\phpbaserowclient\Generated\Model\LocalBaserowUserSourceUserSourceRoles();
        ...
        {
            return [\cedricziel\phpbaserowclient\Generated\Model\LocalBaserowUserSourceUserSourceRoles::class => false];
        }
    }
} else {
    class LocalBaserowUserSourceUserSourceRolesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
