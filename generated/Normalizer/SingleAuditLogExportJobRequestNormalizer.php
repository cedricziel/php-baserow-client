...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SingleAuditLogExportJobRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \cedricziel\phpbaserowclient\Generated\Model\SingleAuditLogExportJobRequest::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \cedricziel\phpbaserowclient\Generated\Model\SingleAuditLogExportJobRequest::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \cedricziel\phpbaserowclient\Generated\Model\SingleAuditLogExportJobRequest();
        ...
        {
            return [\cedricziel\phpbaserowclient\Generated\Model\SingleAuditLogExportJobRequest::class => false];
        }
    }
} else {
    class SingleAuditLogExportJobRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
