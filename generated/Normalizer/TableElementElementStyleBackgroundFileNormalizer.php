...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TableElementElementStyleBackgroundFileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \CedricZiel\Baserow\Generated\Model\TableElementElementStyleBackgroundFile::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \CedricZiel\Baserow\Generated\Model\TableElementElementStyleBackgroundFile::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CedricZiel\Baserow\Generated\Model\TableElementElementStyleBackgroundFile();
        ...
        {
            return [\CedricZiel\Baserow\Generated\Model\TableElementElementStyleBackgroundFile::class => false];
        }
    }
} else {
    class TableElementElementStyleBackgroundFileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
