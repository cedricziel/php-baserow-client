...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class InstallTemplateJobJobNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \cedricziel\phpbaserowclient\Generated\Model\InstallTemplateJobJob::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \cedricziel\phpbaserowclient\Generated\Model\InstallTemplateJobJob::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \cedricziel\phpbaserowclient\Generated\Model\InstallTemplateJobJob();
            ...
            if (\array_key_exists('workspace', $data)) {
                $object->setWorkspace($this->denormalizer->denormalize($data['workspace'], \cedricziel\phpbaserowclient\Generated\Model\InstallTemplateJobJobWorkspace::class, 'json', $context));
                unset($data['workspace']);
            }
            if (\array_key_exists('template', $data)) {
                $object->setTemplate($this->denormalizer->denormalize($data['template'], \cedricziel\phpbaserowclient\Generated\Model\InstallTemplateJobJobTemplate::class, 'json', $context));
                unset($data['template']);
            }
            ...
            if (\array_key_exists('group', $data)) {
                $object->setGroup($this->denormalizer->denormalize($data['group'], \cedricziel\phpbaserowclient\Generated\Model\InstallTemplateJobJobGroup::class, 'json', $context));
                unset($data['group']);
            }
        ...
        {
            return [\cedricziel\phpbaserowclient\Generated\Model\InstallTemplateJobJob::class => false];
        }
    }
} else {
    class InstallTemplateJobJobNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
