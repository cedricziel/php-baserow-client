...
class ExampleRowResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('field19') && null !== $data->getField19()) {
            $dataArray['field_19'] = $data->getField19();
        }
        if ($data->isInitialized('field20') && null !== $data->getField20()) {
            $dataArray['field_20'] = $data->getField20();
        }
        if ($data->isInitialized('field21') && null !== $data->getField21()) {
            $dataArray['field_21'] = $data->getField21();
        }
        if ($data->isInitialized('field22') && null !== $data->getField22()) {
