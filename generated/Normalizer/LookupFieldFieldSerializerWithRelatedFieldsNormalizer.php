...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LookupFieldFieldSerializerWithRelatedFieldsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('throughFieldName') && null !== $object->getThroughFieldName()) {
                $data['through_field_name'] = $object->getThroughFieldName();
            }
            if ($object->isInitialized('targetFieldId') && null !== $object->getTargetFieldId()) {
                $data['target_field_id'] = $object->getTargetFieldId();
            }
            if ($object->isInitialized('targetFieldName') && null !== $object->getTargetFieldName()) {
                $data['target_field_name'] = $object->getTargetFieldName();
            }
