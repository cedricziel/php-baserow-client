...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ExampleRowResponseSerializerWithUserFieldNamesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \CedricZiel\Baserow\Generated\Model\ExampleRowResponseSerializerWithUserFieldNames::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \CedricZiel\Baserow\Generated\Model\ExampleRowResponseSerializerWithUserFieldNames::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CedricZiel\Baserow\Generated\Model\ExampleRowResponseSerializerWithUserFieldNames();
            ...
            if (\array_key_exists('field_10', $data)) {
                $object->setField10($this->denormalizer->denormalize($data['field_10'], \CedricZiel\Baserow\Generated\Model\ExampleRowResponseSerializerWithUserFieldNamesField10::class, 'json', $context));
                unset($data['field_10']);
            }
            ...
            if (\array_key_exists('field_12', $data)) {
                $object->setField12($this->denormalizer->denormalize($data['field_12'], \CedricZiel\Baserow\Generated\Model\ExampleRowResponseSerializerWithUserFieldNamesField12::class, 'json', $context));
                unset($data['field_12']);
            }
            ...
            if (\array_key_exists('field_16', $data) && null !== $data['field_16']) {
                $object->setField16($this->denormalizer->denormalize($data['field_16'], \CedricZiel\Baserow\Generated\Model\ExampleRowResponseSerializerWithUserFieldNamesField16::class, 'json', $context));
                unset($data['field_16']);
        ...
        {
            return [\CedricZiel\Baserow\Generated\Model\ExampleRowResponseSerializerWithUserFieldNames::class => false];
        }
    }
} else {
    class ExampleRowResponseSerializerWithUserFieldNamesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
