...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ChoiceElementUpdateElementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \cedricziel\phpbaserowclient\Generated\Model\ChoiceElementUpdateElement::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \cedricziel\phpbaserowclient\Generated\Model\ChoiceElementUpdateElement::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \cedricziel\phpbaserowclient\Generated\Model\ChoiceElementUpdateElement();
            ...
            if (\array_key_exists('style_background_file', $data) && null !== $data['style_background_file']) {
                $object->setStyleBackgroundFile($this->denormalizer->denormalize($data['style_background_file'], \cedricziel\phpbaserowclient\Generated\Model\ChoiceElementUpdateElementStyleBackgroundFile::class, 'json', $context));
            ...
            if (\array_key_exists('options', $data)) {
                ...
                foreach ($data['options'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \cedricziel\phpbaserowclient\Generated\Model\ChoiceOption::class, 'json', $context);
                }
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('multiple') && null !== $object->getMultiple()) {
                $data['multiple'] = $object->getMultiple();
            }
            if ($object->isInitialized('showAsDropdown') && null !== $object->getShowAsDropdown()) {
                $data['show_as_dropdown'] = $object->getShowAsDropdown();
            }
            if ($object->isInitialized('optionType') && null !== $object->getOptionType()) {
                $data['option_type'] = $object->getOptionType();
            }
            if ($object->isInitialized('formulaValue') && null !== $object->getFormulaValue()) {
                $data['formula_value'] = $object->getFormulaValue();
            }
            if ($object->isInitialized('formulaName') && null !== $object->getFormulaName()) {
                $data['formula_name'] = $object->getFormulaName();
            }
        ...
        {
            return [\cedricziel\phpbaserowclient\Generated\Model\ChoiceElementUpdateElement::class => false];
        }
    }
} else {
    class ChoiceElementUpdateElementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
