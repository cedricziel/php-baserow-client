...
class AIFieldFieldSerializerWithRelatedFieldsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('aiGenerativeAiType') && null !== $data->getAiGenerativeAiType()) {
            $dataArray['ai_generative_ai_type'] = $data->getAiGenerativeAiType();
        }
        if ($data->isInitialized('aiGenerativeAiModel') && null !== $data->getAiGenerativeAiModel()) {
        ...
        if ($data->isInitialized('aiFileFieldId') && null !== $data->getAiFileFieldId()) {
