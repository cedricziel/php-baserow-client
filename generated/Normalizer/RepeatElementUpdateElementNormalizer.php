...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RepeatElementUpdateElementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \cedricziel\phpbaserowclient\Generated\Model\RepeatElementUpdateElement::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \cedricziel\phpbaserowclient\Generated\Model\RepeatElementUpdateElement::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \cedricziel\phpbaserowclient\Generated\Model\RepeatElementUpdateElement();
            ...
            if (\array_key_exists('style_background_file', $data) && null !== $data['style_background_file']) {
                $object->setStyleBackgroundFile($this->denormalizer->denormalize($data['style_background_file'], \cedricziel\phpbaserowclient\Generated\Model\RepeatElementUpdateElementStyleBackgroundFile::class, 'json', $context));
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('dataSourceId') && null !== $object->getDataSourceId()) {
            ...
            if ($object->isInitialized('buttonLoadMoreLabel') && null !== $object->getButtonLoadMoreLabel()) {
                $data['button_load_more_label'] = $object->getButtonLoadMoreLabel();
            }
            if ($object->isInitialized('orientation') && null !== $object->getOrientation()) {
                $data['orientation'] = $object->getOrientation();
            }
            if ($object->isInitialized('itemsPerRow') && null !== $object->getItemsPerRow()) {
                $data['items_per_row'] = $object->getItemsPerRow();
            }
        ...
        {
            return [\cedricziel\phpbaserowclient\Generated\Model\RepeatElementUpdateElement::class => false];
        }
    }
} else {
    class RepeatElementUpdateElementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
