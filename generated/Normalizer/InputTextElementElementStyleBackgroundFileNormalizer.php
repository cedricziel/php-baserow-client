...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class InputTextElementElementStyleBackgroundFileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \CedricZiel\Baserow\Generated\Model\InputTextElementElementStyleBackgroundFile::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \CedricZiel\Baserow\Generated\Model\InputTextElementElementStyleBackgroundFile::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CedricZiel\Baserow\Generated\Model\InputTextElementElementStyleBackgroundFile();
        ...
        {
            return [\CedricZiel\Baserow\Generated\Model\InputTextElementElementStyleBackgroundFile::class => false];
        }
    }
} else {
    class InputTextElementElementStyleBackgroundFileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
