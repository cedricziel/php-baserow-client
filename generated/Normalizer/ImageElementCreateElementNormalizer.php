...
class ImageElementCreateElementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \CedricZiel\Baserow\Generated\Model\ImageElementCreateElement::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \CedricZiel\Baserow\Generated\Model\ImageElementCreateElement::class === get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \CedricZiel\Baserow\Generated\Model\ImageElementCreateElement();
        ...
        if (\array_key_exists('style_background_file', $data) && null !== $data['style_background_file']) {
            $object->setStyleBackgroundFile($this->denormalizer->denormalize($data['style_background_file'], \CedricZiel\Baserow\Generated\Model\ImageElementCreateElementStyleBackgroundFile::class, 'json', $context));
        ...
        if (\array_key_exists('image_file', $data) && null !== $data['image_file']) {
            $object->setImageFile($this->denormalizer->denormalize($data['image_file'], \CedricZiel\Baserow\Generated\Model\ImageElementCreateElementImageFile::class, 'json', $context));
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('imageSourceType') && null !== $data->getImageSourceType()) {
            $dataArray['image_source_type'] = $data->getImageSourceType();
        }
        if ($data->isInitialized('imageFile') && null !== $data->getImageFile()) {
            $dataArray['image_file'] = $this->normalizer->normalize($data->getImageFile(), 'json', $context);
        }
        if ($data->isInitialized('imageUrl') && null !== $data->getImageUrl()) {
            $dataArray['image_url'] = $data->getImageUrl();
        }
        if ($data->isInitialized('altText') && null !== $data->getAltText()) {
            $dataArray['alt_text'] = $data->getAltText();
        }
        if ($data->isInitialized('alignment') && null !== $data->getAlignment()) {
            $dataArray['alignment'] = $data->getAlignment();
        }
        if ($data->isInitialized('styleImageConstraint') && null !== $data->getStyleImageConstraint()) {
            $dataArray['style_image_constraint'] = $data->getStyleImageConstraint();
        }
        if ($data->isInitialized('styleMaxWidth') && null !== $data->getStyleMaxWidth()) {
            $dataArray['style_max_width'] = $data->getStyleMaxWidth();
        }
        if ($data->isInitialized('styleMaxHeight') && null !== $data->getStyleMaxHeight()) {
            $dataArray['style_max_height'] = $data->getStyleMaxHeight();
        }
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
    ...
    {
        return [\CedricZiel\Baserow\Generated\Model\ImageElementCreateElement::class => false];
    }
}
