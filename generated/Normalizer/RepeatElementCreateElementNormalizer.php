...
class RepeatElementCreateElementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \CedricZiel\Baserow\Generated\Model\RepeatElementCreateElement::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \CedricZiel\Baserow\Generated\Model\RepeatElementCreateElement::class === get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \CedricZiel\Baserow\Generated\Model\RepeatElementCreateElement();
        ...
        if (\array_key_exists('style_background_file', $data) && null !== $data['style_background_file']) {
            $object->setStyleBackgroundFile($this->denormalizer->denormalize($data['style_background_file'], \CedricZiel\Baserow\Generated\Model\RepeatElementCreateElementStyleBackgroundFile::class, 'json', $context));
        ...
        if (\array_key_exists('button_load_more_label', $data)) {
            $object->setButtonLoadMoreLabel($data['button_load_more_label']);
            unset($data['button_load_more_label']);
        }
        if (\array_key_exists('orientation', $data)) {
            $object->setOrientation($data['orientation']);
            unset($data['orientation']);
        }
        if (\array_key_exists('items_per_row', $data)) {
            $object->setItemsPerRow($data['items_per_row']);
            unset($data['items_per_row']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('dataSourceId') && null !== $data->getDataSourceId()) {
            $dataArray['data_source_id'] = $data->getDataSourceId();
        }
        if ($data->isInitialized('itemsPerPage') && null !== $data->getItemsPerPage()) {
            $dataArray['items_per_page'] = $data->getItemsPerPage();
        }
        if ($data->isInitialized('buttonLoadMoreLabel') && null !== $data->getButtonLoadMoreLabel()) {
            $dataArray['button_load_more_label'] = $data->getButtonLoadMoreLabel();
        }
        if ($data->isInitialized('orientation') && null !== $data->getOrientation()) {
            $dataArray['orientation'] = $data->getOrientation();
        }
        if ($data->isInitialized('itemsPerRow') && null !== $data->getItemsPerRow()) {
            $dataArray['items_per_row'] = $data->getItemsPerRow();
        }
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
    ...
    {
        return [\CedricZiel\Baserow\Generated\Model\RepeatElementCreateElement::class => false];
    }
}
