...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GeneratedConditionalColorViewDecorationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \cedricziel\phpbaserowclient\Generated\Model\GeneratedConditionalColorViewDecoration::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \cedricziel\phpbaserowclient\Generated\Model\GeneratedConditionalColorViewDecoration::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \cedricziel\phpbaserowclient\Generated\Model\GeneratedConditionalColorViewDecoration();
            ...
            if (\array_key_exists('value_provider_conf', $data)) {
                $object->setValueProviderConf($this->denormalizer->denormalize($data['value_provider_conf'], \cedricziel\phpbaserowclient\Generated\Model\GeneratedConditionalColorViewDecorationValueProviderConf::class, 'json', $context));
        ...
        {
            return [\cedricziel\phpbaserowclient\Generated\Model\GeneratedConditionalColorViewDecoration::class => false];
        }
    }
} else {
    class GeneratedConditionalColorViewDecorationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
