...
class FormContainerElementPublicElementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \CedricZiel\Baserow\Generated\Model\FormContainerElementPublicElement::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \CedricZiel\Baserow\Generated\Model\FormContainerElementPublicElement::class === get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \CedricZiel\Baserow\Generated\Model\FormContainerElementPublicElement();
        if (\array_key_exists('reset_initial_values_post_submission', $data) && \is_int($data['reset_initial_values_post_submission'])) {
            $data['reset_initial_values_post_submission'] = (bool) $data['reset_initial_values_post_submission'];
        }
        ...
        if (\array_key_exists('style_background_file', $data) && null !== $data['style_background_file']) {
            $object->setStyleBackgroundFile($this->denormalizer->denormalize($data['style_background_file'], \CedricZiel\Baserow\Generated\Model\FormContainerElementPublicElementStyleBackgroundFile::class, 'json', $context));
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('submitButtonLabel') && null !== $data->getSubmitButtonLabel()) {
            $dataArray['submit_button_label'] = $data->getSubmitButtonLabel();
        }
        if ($data->isInitialized('buttonColor') && null !== $data->getButtonColor()) {
            $dataArray['button_color'] = $data->getButtonColor();
        }
        if ($data->isInitialized('resetInitialValuesPostSubmission') && null !== $data->getResetInitialValuesPostSubmission()) {
    ...
    {
        return [\CedricZiel\Baserow\Generated\Model\FormContainerElementPublicElement::class => false];
    }
}
