...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocalBaserowGetRowDataSourceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \cedricziel\phpbaserowclient\Generated\Model\LocalBaserowGetRowDataSource::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \cedricziel\phpbaserowclient\Generated\Model\LocalBaserowGetRowDataSource::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \cedricziel\phpbaserowclient\Generated\Model\LocalBaserowGetRowDataSource();
            ...
            if (\array_key_exists('filters', $data)) {
                $values_3 = [];
                foreach ($data['filters'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, \cedricziel\phpbaserowclient\Generated\Model\LocalBaserowTableServiceFilter::class, 'json', $context);
                }
                $object->setFilters($values_3);
                unset($data['filters']);
            }
        ...
        {
            return [\cedricziel\phpbaserowclient\Generated\Model\LocalBaserowGetRowDataSource::class => false];
        }
    }
} else {
    class LocalBaserowGetRowDataSourceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
