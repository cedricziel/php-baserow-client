...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocalBaserowGetRowDataSourceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \CedricZiel\Baserow\Generated\Model\LocalBaserowGetRowDataSource::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && \CedricZiel\Baserow\Generated\Model\LocalBaserowGetRowDataSource::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CedricZiel\Baserow\Generated\Model\LocalBaserowGetRowDataSource();
            ...
            if (\array_key_exists('filters', $data)) {
                ...
                foreach ($data['filters'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, \CedricZiel\Baserow\Generated\Model\LocalBaserowTableServiceFilter::class, 'json', $context);
                }
        ...
        {
            return [\CedricZiel\Baserow\Generated\Model\LocalBaserowGetRowDataSource::class => false];
        }
    }
} else {
    class LocalBaserowGetRowDataSourceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
